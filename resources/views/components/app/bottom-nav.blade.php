...
<nav class="fixed inset-x-0 bottom-0 z-30" aria-label="Primary">
    <div class="mx-auto max-w-md">
        <div class="relative flex items-end justify-around border-t border-zinc-100 bg-white/95 px-2 pb-[env(safe-area-inset-bottom)] pt-2 backdrop-blur">
            ...
            {{-- Home --}}
            <a href="{{ $home['href'] }}" @if($home['active']) aria-current="page" @endif
            ...
            {{-- Pantry --}}
            <a href="{{ $pantry['href'] }}" @if($pantry['active']) aria-current="page" @endif
            ...
            {{-- Eat --}}
            <a href="{{ $eat['href'] }}" @if($eat['active']) aria-current="page" @endif
            ...
            {{-- Health --}}
            <a href="{{ $health['href'] }}" @if($health['active']) aria-current="page" @endif
