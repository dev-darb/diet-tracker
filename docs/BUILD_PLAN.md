...
- **Next design tranches (queued):** (5) outcome rewards (target-hit state on the Home scale, streak completion, day-close moment); (6) front-door console pass (welcome/auth/onboarding/profile/settings out of the emerald starter dialect).
